    ...
    return (
        <ul className="list-group">
            ...
            {subs && (
                ...
                Sub Category
                {subs.map((s) => 
                    <Link key={`/sub/${s.slug}`} to={`/sub/${s.slug}`} className="label label-default label-pill pull-xs-right"> 
                        {s.name} 
                    </Link>
                )}
            </li>
            ...
            <li className="list-group-item">
                Avaible{" "} <span className="label label-default label-pill pull-xs-right"> {quantity} </span>
            </li>
